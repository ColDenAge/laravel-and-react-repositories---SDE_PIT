          ...
          {privacySettings.map((setting) => (
            ...
            >
              <div className="flex flex-col">
                <span className="font-['Cairo-SemiBold',Helvetica] font-semibold text-black text-lg leading-[27px]">
                  {setting.title}
                </span>
                <span className="font-['Cairo-Regular',Helvetica] font-normal text-black text-sm leading-[21px]">
                  {setting.description}
                </span>
              </div>
              <Switch
