              ...
              <CardContent className="p-6">
                <div className="flex justify-between items-start">
                  <div className="space-y-2">
                    ...
                    <p className="text-base font-normal text-black [font-family:'Cairo-Regular',Helvetica]">
                  ...
                  <div className="flex space-x-2">
                    ...
                    <Button
                      variant="outline"
                      className="h-10 w-[76px] bg-[#ff525220] text-[#ff5252] border-0 [font-family:'Cairo-Regular',Helvetica]"
                    >
                      Delete
                    </Button>
                  </div>
