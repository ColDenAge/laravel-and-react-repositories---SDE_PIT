              ...
              <div className="flex flex-col gap-2">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="mt-2 text-base text-black font-normal font-['Cairo-Regular',Helvetica]">
                      {plan.description}
                    </p>
                  </div>
                  <div className="flex gap-2">
                    <Button className="h-10 w-[58px] bg-[#0b294b] text-white font-normal font-['Cairo-Regular',Helvetica]">
                      Edit
                    </Button>
                    <Button
                      variant="ghost"
                      className="h-10 w-[76px] bg-[#ff525220] text-[#ff5252] hover:bg-[#ff525230] hover:text-[#ff5252] font-normal font-['Cairo-Regular',Helvetica]"
                    >
                      Delete
                    </Button>
                  </div>
                ...
                <div className="flex justify-between mt-4">
                  <div>
                    ...
                    <p className="text-base text-black font-normal font-['Cairo-Regular',Helvetica]">
                      {plan.price}
                    </p>
                  </div>
                  <div>
