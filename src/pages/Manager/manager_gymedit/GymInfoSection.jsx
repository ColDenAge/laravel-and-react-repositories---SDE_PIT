      ...
      <CardContent className="space-y-6">
        <div className="grid grid-cols-2 gap-12">
          ...
          <div className="space-y-2">
            <Label className="font-['Cairo-Regular',Helvetica] font-normal">
              Gym Name
            </Label>
            <div className="bg-[#e9ecef] rounded-lg h-[55px] flex items-center px-4">
              <span className="text-sm font-['Cairo-Regular',Helvetica]">
                {gymData.name}
              </span>
            </div>
          </div>
        ...
        <div className="space-y-2">
          ...
          <div className="bg-[#e9ecef] rounded-lg p-3 min-h-[100px]">
            <p className="text-sm font-['Cairo-Regular',Helvetica] leading-[21px]">
              {gymData.description}
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-end gap-4 pt-4">
          <Button className="bg-[#0b294b] text-white font-['Cairo-Bold',Helvetica] font-bold h-12 w-[147px]">
            Upload Picture
          </Button>
          <Button className="bg-[#0b294b] text-white font-['Cairo-Bold',Helvetica] font-bold h-12 w-[147px]">
            Cancel
